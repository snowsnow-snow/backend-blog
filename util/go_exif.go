...
func (_ *GoExif) ReadExif(path string, fileName string, fileType string) *models.ImgInfo {
...
func (_ *GoExif) ReadFujiInfo(imgInfo models.ImgInfo, exifData map[string]interface{}) {
}
